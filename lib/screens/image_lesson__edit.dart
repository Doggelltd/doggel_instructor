...
class ImageLessonEditScreen extends StatefulWidget {
  ...
  _ImageLessonEditScreenState createState() => _ImageLessonEditScreenState();
}

class _ImageLessonEditScreenState extends State<ImageLessonEditScreen> {
  dynamic lessonType;
  var lessonTypeValue = "other-img";
  ...
  Future uploadImage(String title, String lessonId, String sectionId,
    ...
    try {
      if (imageFile != null) {
        ...
        file = await MultipartFile.fromFile(imageFile, filename: fileName);
