...
class TextAddScreen extends StatefulWidget {
  final dynamic type;
  ...
  _TextAddScreenState createState() => _TextAddScreenState();
}
...
class _TextAddScreenState extends State<TextAddScreen> {
  GlobalKey<FormState> globalFormKey = GlobalKey<FormState>();
  final scaffoldKey = GlobalKey<ScaffoldState>();

  dynamic lessonType = "Text";
                ...
                child: Padding(
                  ...
                  child: MaterialButton(
                    onPressed: () async {
                      ...
                      var data = _textController.text.toString();
