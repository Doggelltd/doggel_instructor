...
class VideoUrlAddScreen extends StatefulWidget {
  final dynamic type;
  final String courseId;
  final String courseTitle;

  const VideoUrlAddScreen(
      {Key? key,
      required this.type,
  ...
  _VideoUrlAddScreenState createState() => _VideoUrlAddScreenState();
}
...
class _VideoUrlAddScreenState extends State<VideoUrlAddScreen> {
  GlobalKey<FormState> globalFormKey = GlobalKey<FormState>();
  final scaffoldKey = GlobalKey<ScaffoldState>();

  dynamic lessonType = "Html5 video";
  var lessonTypeValue = "video-url";
  dynamic lessonProvider = "html5";
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value!.isEmpty) {
                            return 'Html5 video url cannot be empty';
                          }
                          return null;
                        },
                        onSaved: (value) {
