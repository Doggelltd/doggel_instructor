...
// import 'package:ac/models/update_user_model.dart';
...
Future<UpdateUserModel> verifyEmail(
  ...
  const String apiUrl = "$BASE_URL/api_instructor/verify_email_address";
...
Future<UpdateUserModel> resendCode(String email) async {
  const String apiUrl = "$BASE_URL/api_instructor/resend_verification_code";
