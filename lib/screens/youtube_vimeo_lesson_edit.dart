...
class YoutubeVimeoEditScreen extends StatefulWidget {
  ...
  _YoutubeVimeoEditScreenState createState() => _YoutubeVimeoEditScreenState();
}
...
class _YoutubeVimeoEditScreenState extends State<YoutubeVimeoEditScreen> {
  dynamic lessonType;
            ...
            builder: (context, dataSnapshot) {
              if (dataSnapshot.connectionState == ConnectionState.waiting) {
                ...
                if (dataSnapshot.error != null) {
                  ...
                  if (dataSnapshot.data!.videoType == "YouTube") {
                    lessonProvider = "youtube";
                  } else if (dataSnapshot.data!.videoType == "system") {
                    lessonProvider = "youtube";
                  } else {
