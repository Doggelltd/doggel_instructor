...
class TextLessonEditScreen extends StatefulWidget {
  ...
  _TextLessonEditScreenState createState() => _TextLessonEditScreenState();
}
...
class _TextLessonEditScreenState extends State<TextLessonEditScreen> {
  dynamic lessonType;
  var lessonTypeValue = "text-description";
            ...
            builder: (context, dataSnapshot) {
              if (dataSnapshot.connectionState == ConnectionState.waiting) {
                ...
                if (dataSnapshot.error != null) {
                  ...
                  // dropDownValueOne = dataSnapshot.data.sectionId;
                  _textController.text = dataSnapshot.data!.attachment!;
                            ...
                            Expanded(
                              ...
                              child: MaterialButton(
                                onPressed: () async {
                                  ...
                                  var text = _textController.text.toString();
                                  var summary =
