...
class GoogleDriveLessonEditScreen extends StatefulWidget {
  ...
  const GoogleDriveLessonEditScreen(
      {Key? key,
  ...
  _GoogleDriveLessonEditScreenState createState() =>
      _GoogleDriveLessonEditScreenState();
}

class _GoogleDriveLessonEditScreenState
    extends State<GoogleDriveLessonEditScreen> {
  dynamic lessonType;
