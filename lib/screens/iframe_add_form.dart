...
class IframeAddScreen extends StatefulWidget {
  final dynamic type;
  final String courseId;
  final String courseTitle;

  const IframeAddScreen(
      {Key? key,
      required this.type,
  ...
  _IframeAddScreenState createState() => _IframeAddScreenState();
}
...
class _IframeAddScreenState extends State<IframeAddScreen> {
  GlobalKey<FormState> globalFormKey = GlobalKey<FormState>();
  final scaffoldKey = GlobalKey<ScaffoldState>();

  dynamic lessonType = "Iframe embed";
  var lessonTypeValue = "other-iframe";
                    ...
                    children: <Widget>[
                      ...
                      const Padding(
                        ...
                        child: Align(
                          alignment: Alignment.centerLeft,
                          child: Text(
                            'Iframe source ( Provide the source only )',
                            style: TextStyle(
                              color: kTextColor,
                              fontSize: 15,
                            ),
